...
//Question – 1: ______
//        Write a program that prompts the user to enter a Social Security number in the format DDD-DDDDDD, where D is a digit. Your program should check whether the input is valid. Here are
//        sample runs:
