...
public class Activity18Switch {
    public static void main(String[] args) {
        ...
        switch (bookPurchased) {
            case 0: System.out.println("You earned 0 points !");
                break;
            case 1: System.out.println("You earned 5 points !");
                break;
            case 2: System.out.println("You earned 15 points !");
                break;
            case 3: System.out.println("You earned 30 points !");
                break;
            case 4: System.out.println("You earned 60 points !");
            break;
            // in case if more than 4 books are purchased!
            default: System.out.println("You have earned 60 points !");

//            the limitation of this program is that it works only when we give positive input
        }
    }
}
